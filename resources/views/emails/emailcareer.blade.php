            ...
            <table cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td class="title" style="text-align:left;padding:0 0 20px 0; vertical-align: top;"><img
                            src="https://workpermitcloud.co.uk/frontend/img/logo.png" /> </td>
                </tr>
            </table>
        </td>
    </tr>
            ...
            <table width="560" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td align="left" valign="top"
                        ...
                        <p>New Application form Career submission given below:</p>
                        <p>Position : {{$pos}}</p>
                        <p>Name : {{$name}}</p>
                        <p>Email : {{$email}}</p>
                        <p>Phone Number : {{$mob}}</p>
                    ...
                    <td style="padding:20px 0 0 0; vertical-align: top; text-align: center; border-top:1px solid #ccc;">
                        <p
                            ...
                            <a href="mailto:contactus@wiseminesoftware.com"
                                style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; color: #555;text-decoration: none;">contactus@wiseminesoftware.com</a>
                            or call at : (+68)1221 09876
                        </p>
                    </td>
                </tr>
            </table>
