                            ...
                            <div class="col-12">
                                ...
                                <div class="text-center">
                                    <button type="submit" name="btnUpdateProfile"
                                        class="btn btn-secondary col-xl-4 col-lg-4 col-md-12 col-sm-12 btnUpdateProfile"
                            ...
                            <div class="col-12">
                                ...
                                <div class="text-center">
                                    <button type="submit" name="btnChangePassword"
                                        class="btn btn-secondary col-xl-4 col-lg-4 col-md-12 col-sm-12 btnChangePassword"
