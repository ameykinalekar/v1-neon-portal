...
<div class="row">
    <div class="col-12">
                ...
                <div class="card" style="width: 100%; border-radius: 4px !important;">
                    ...
                    <div class="card-body">
                        <h6 class="card-title" style="font-weight: normal;color:#434343">
                            ...
                            <small>{{$record['name'].' - '.$record['academic_year']}}</small>
                        </h6>
                        <a href="{{route('ta_librarycontent',[Session()->get('tenant_info')['subdomain'],\Helpers::encryptId($record['subject_id'])])}}"
                            class="btn w-100"
        ...
        <div class="table-responsive list" id="tableGrid" style="width:100%">
