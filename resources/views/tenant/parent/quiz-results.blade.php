        ...
        <div class="card-header">
                <div class="float-end">
                    <form>
                        ...
                        <select name="studid" id="studid" class="form-control pull-right" style="width: fit-content;"><option value="">Select Student</option></select>
                        ...
                        <select name="ssid" id="ssid" class="form-control pull-right" style="width: fit-content;"><option value="">Select Subject</option></select>
                            ...
                            <div class="input-group-btn">
                                ...
                                <a class="btn btn-light"
                                    href="{{route('p_resultqlist',Session()->get('tenant_info')['subdomain'])}}">Reset</a>
                ...
                <table id="datatable" class="table table-striped  nowrap" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('p_reviewed_answers',[Session()->get('tenant_info')['subdomain'],\Helpers::encryptId($record['user_result_id'])])}}"><i class="fa fa-eye"></i></a>
                            </td>
                        </tr>
                        @endif
                        @endforeach
...
function onPageLoad() {
    ...
    params['errorCallBackFunction'] = function(httpObj) {
        $('#studid').html('<option value="">Select Student</option>');
    }
    params['completeCallbackFunction'] = function(response) {
        @if($studid!=null)
        $('#studid').val("{{$studid}}").trigger('change');
        @endif
    }
    doAjax(params);
}
