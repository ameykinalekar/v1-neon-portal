        ...
        <div class="card">
            <div class="card-body py-1">
                ...
                <button type="button" class="btn btn-outline-primary btn-rounded align-middle mt-1 float-end"
                    onclick="rightModal('{{route('ta_addparent',Session()->get('tenant_info')['subdomain'])}}', 'Add Parent')">
                    <i class="mdi mdi-plus"></i> Add Parent</button>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
                        ...
                        <div class="input-group input-group-sm" style="width: 330px;">
                            ...
                            <div class="input-group-btn">
                                ...
                                <a class="btn btn-light"
                                    href="{{route('ta_parentlist',Session()->get('tenant_info')['subdomain'])}}">Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <table id="datatable" class="table table-striped  nowrap" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0);" title="Edit Parent"
                                        onclick="rightModal('{{route('ta_editparent',[Session()->get('tenant_info')['subdomain'],\Helpers::encryptId($record['user_id'])])}}', 'Edit Parent')"><i
                        ...
                        <nav class="float-end">
                            <ul class="pagination">
                                ...
                                <li class="page-item"><a class="page-link" title="Next Page"
                                        href="{{route('ta_parentlist',Session()->get('tenant_info')['subdomain']).'/?search_text='.$search_text.'&page='.$next_page}}"><span
                                            aria-hidden="true">&raquo;</span></a></li>
                                @elseif(($has_next_page == false) && ($has_previous_page == true))
                                <li class="page-item"><a class="page-link" title="Previous Page"
                                        href="{{route('ta_parentlist',Session()->get('tenant_info')['subdomain']).'/?search_text='.$search_text.'&page='.$prev_page}}"><span
