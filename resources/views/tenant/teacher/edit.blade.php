...
<form method="POST" class="d-block ajaxForm"
    action="{{route('ta_updateteacher',Session()->get('tenant_info')['subdomain'])}}">
    @csrf
    <input type="hidden" name="teacher_id" id="teacher_id" value="{{$teacher_details['user_id']??''}}">
    ...
    <div class="form-row">
        <div class="form-group mb-1">
            ...
            <input type="text" class="form-control" id="first_name" name="first_name"
                value="{{$teacher_details['first_name']??''}}" required>
        </div>
        <div class="form-group mb-1">
            <label for="last_name">Last Name</label>
            <input type="text" class="form-control" id="last_name" name="last_name"
                value="{{$teacher_details['last_name']??''}}">
        </div>
        ...
        <div class="form-group mb-1">
            ...
            <div class="col-md-12" id="section_subject">
                ...
                if(isset($teacher_details['subject_ids']) && $teacher_details['subject_ids']!=null){
                $existing_subject_ids=explode(',',$teacher_details['subject_ids']);
                }
                ...
                <input type="checkbox" class="float-start" name="subject_id[]" id="sub_{{$record['subject_id']}}" checked
        ...
        <div class="form-group mb-1">
            ...
            <input type="text" class="form-control" id="phone" name="phone" value="{{$teacher_details['phone']??''}}"
        ...
        <div class="form-group mb-1">
            ...
            <select class="form-control" id="department_id" name="department_id">
                ...
                @if(isset($teacher_details['department_id']) && $teacher_details['department_id']==$record['department_id'])
        ...
        <div class="form-group mb-1">
            ...
            <select class="form-control" id="gender" name="gender" required>
                ...
                @if(isset($teacher_details['gender']) && $teacher_details['gender']==$record)
        ...
        <div class="form-group mb-1">
            ...
            <select class="form-control" id="is_qualified_faculty" name="is_qualified_faculty" required>
                ...
                <option value="1" @if(isset($teacher_details['is_qualified_faculty']) && $teacher_details['is_qualified_faculty']=='1') selected @endif>Yes</option>
                <option value="0" @if(isset($teacher_details['is_qualified_faculty']) && $teacher_details['is_qualified_faculty']=='0') selected @endif>No</option>
        ...
        <div class="form-group mb-1">
            ...
            <input type="text" class="form-control" id="ni_number" name="ni_number"
                value="{{$teacher_details['ni_number']??''}}" required>
        ...
        <div class="form-group mb-1">
            ...
            <textarea class="form-control" id="address" name="address"
                rows="5">{{$teacher_details['address']??''}}</textarea>
        </div>
        <div class="form-group mb-1">
            <label for="about">About</label>
            <textarea class="form-control" id="about" name="about" rows="5">{{$teacher_details['about']??''}}</textarea>
        </div>
        <div class="form-group mb-1">
            <label for="short_name">Status</label>
            {{ Form::select('status',$status, $teacher_details['status']??'', array('class' => 'form-control select2_el','required','id' => 'record_status','placeholder' => 'Select Status')) }}
        </div>
        <div class="form-group mb-1">
            ...
            <div class="custom-file-upload">
                ...
                @if($teacher_details['user_logo']!='')
                <span>
                    <a class="fancy-box-a" data-fancybox="demo" data-caption="Profile Image"
                        href="{{config('app.api_asset_url') . $teacher_details['user_logo']}}"><img
                            style="padding-top: 13px;"
                            src="{{config('app.api_asset_url') . $teacher_details['user_logo']}}" height="auto"
                            width="70px" /></a>
                </span>
                @endif
        ...
        <div class="form-group mb-1">
            ...
            <input type="date" class="form-control" id="end_date_id" name="end_date_id" value="{{$teacher_details['end_date_id']??null}}">
        </div>
        <div class="form-group mb-1">
            ...
            <div class="custom-file-upload">
                <input type="file" class="form-control" id="id_file" name="id_file"
                    accept="image/x-png,image/jpeg,image/png;capture=camera">
                <input type="hidden" name="existing_id_file" id="existing_id_file" value="{{$teacher_details['id_file']}}">
                @if($teacher_details['id_file']!='')
                <span>
                    <a class="fancy-box-a" data-fancybox="demo" data-caption="National(government) Id Image"
                        href="{{config('app.api_asset_url') . $teacher_details['id_file']}}"><img
                            style="padding-top: 13px;"
                            src="{{config('app.api_asset_url') . $teacher_details['id_file']}}" height="auto"
                            width="70px" /></a>
                </span>
                @endif
        ...
        <div class="form-group mb-1">
            ...
            <input type="date" class="form-control" id="end_date_dbs" name="end_date_dbs" value="{{$teacher_details['end_date_dbs']??null}}">
        </div>
        <div class="form-group mb-1">
            ...
            <div class="custom-file-upload">
                <input type="file" class="form-control" id="dbs_certificate_file" name="dbs_certificate_file"
                    accept="image/x-png,image/jpeg,image/png;capture=camera">
                <input type="hidden" name="existing_dbs_certificate_file" id="existing_dbs_certificate_file" value="{{$teacher_details['dbs_certificate_file']}}">
                @if($teacher_details['dbs_certificate_file']!='')
                <span>
                    <a class="fancy-box-a" data-fancybox="demo" data-caption="Dbs Certificate Image"
                        href="{{config('app.api_asset_url') . $teacher_details['dbs_certificate_file']}}"><img
                            style="padding-top: 13px;"
                            src="{{config('app.api_asset_url') . $teacher_details['dbs_certificate_file']}}"
...
$(document).ready(function() {
    ...
    $("#end_date_id").change(function(){
        var existing_id_file=$('#existing_id_file').val();
    ...
    //     var existing_dbs_certificate_file=$('#existing_dbs_certificate_file').val();
