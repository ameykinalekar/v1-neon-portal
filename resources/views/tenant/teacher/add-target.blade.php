        ...
        <div class="card">
            <div class="card-body py-1">
                <h4 class="page-title d-inline-block">
                    <i class="mdi mdi-account-circle title_icon"></i> Add Student Target
                </h4>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body admin_content">
                <form method="POST" class="d-block ajaxForm" action="{{route('tut_starget_save',Session()->get('tenant_info')['subdomain'])}}" id="frmPage">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group required">
                                ...
                                <input type="date" class="form-control" id="set_date" name="set_date" required>
                            </div>
                        </div>
...
$("#user_id").on('change', function() {
    ...
    params['successCallbackFunction'] = function(response) {
        ...
        response.result.details.forEach(function(item) {
            ...
            option = option + `<td><input class="form-control" type="number" step="any" min="1" name="target[]"></td>`;
            option = option + `<td><input class="form-control" type="date"  name="target_date[]"></td>`;
            option = option + `</tr>`;
