...
<form method="POST" class="d-block ajaxForm"
    action="{{route('ta_savetopic',Session()->get('tenant_info')['subdomain'])}}">
    @csrf
    ...
    <div class="form-row">
        ...
        <div class="form-group mb-1">
            ...
            <input type="text" class="form-control" id="topic" name="topic" maxlength=255 required>
        </div>
        ...
        <div class="form-group mt-2 col-md-12">
            <button class="btn btn-block btn-primary" id="submitBtn" type="submit">Save Topic</button>
        </div>
    </div>
</form>
@endsection
