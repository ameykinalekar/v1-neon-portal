        ...
        <div class="card">
            <div class="card-body py-1">
                <div class="page-title">
                    ...
                    onclick="rightModal('{{route('ta_addmsg',Session()->get('tenant_info')['subdomain'])}}', 'New Message')"> <i class="mdi mdi-plus"></i> Add
                    Message</button>
                </div>
                ...
                <div class="table-responsive">
                    <table id="datatable" class="table table-striped  nowrap" width="100%">
                        ...
                        <tr>
                            ...
                            <td @if($record['is_read']<1) style="font-weight:600;" @endif><a href="javascript:void(0);" title="View Message"
                            onclick="questionModal('{{route('view_message',[Session()->get('tenant_info')['subdomain'],\Helpers::encryptId($record['message_id'])])}}', '{{$modalTitle}}')"> {!! \Helpers::excerpt(strip_tags($record['message']),50) !!}</a></td>
