                ...
                <div class="page-title">
                   <h4> <i ></i> Library</h4>
                    <span id="btnContainer">
                        <a href="{{route('ta_librarycontent',[Session()->get('tenant_info')['subdomain'],\Helpers::encryptId($lesson_info['subject']['subject_id'])])}}"
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body py-1">
                <h4 class="page-title">{{$lib_content_types[$content_type]}} Contents </h4>
                    ...
                    @endphp
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:void(0);" onclick="rightModal('{{route('ta_editlibrarycontent',[Session()->get('tenant_info')['subdomain'],\Helpers::encryptId($record['library_id'])])}}', 'Edit content')" class="btn btn-sm btn-default" title="Edit content to this lesson"><i class="fa fa-edit"></i></a>
