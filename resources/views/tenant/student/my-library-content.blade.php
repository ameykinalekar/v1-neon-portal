            ...
            <div class="card-body py-1">
                <div class="page-title">
                    ...
                    <span id="btnContainer">
                        <a href="{{route('tus_mylibrary',Session()->get('tenant_info')['subdomain'])}}"
                            ...
                            <div class="accordion-body">
                                <div class="row">
                                    <div class="col-md-3 py-2">
                                        <a
                                            href="{{route('tus_libcontentbytype',[Session()->get('tenant_info')['subdomain'],\Helpers::encryptId($record['lesson_id']),'N'])}}"><i
                                                class="fa fa-file-text"></i> Teacher Notes
                                            ({{$record['total_notes']}})</a>
                                    </div>
                                    <div class="col-md-3 py-2">
                                        <a
                                            href="{{route('tus_libcontentbytype',[Session()->get('tenant_info')['subdomain'],\Helpers::encryptId($record['lesson_id']),'M'])}}"><i
                                                class="fa fa-code-fork rotate-180"></i> Mindmaps
                                            ({{$record['total_mindmaps']}})</a>
                                    </div>
                                    <div class="col-md-3 py-2">
                                        <a
                                            href="{{route('tus_libcontentbytype',[Session()->get('tenant_info')['subdomain'],\Helpers::encryptId($record['lesson_id']),'V'])}}"><i
                                                class="fa fa-video"></i> Videos ({{$record['total_videos']}})</a>
                                    </div>
                                    <div class="col-md-3 py-2">
                                        <a
                                            href="{{route('tus_libcontentbytype',[Session()->get('tenant_info')['subdomain'],\Helpers::encryptId($record['lesson_id']),'P'])}}"><i
                                                class="fa fa-file"></i> PPTs ({{$record['total_ppts']}})</a>
                                    </div>
                                    <div class="col-md-3 py-2">
                                        <a
                                            href="{{route('tus_libcontentbytype',[Session()->get('tenant_info')['subdomain'],\Helpers::encryptId($record['lesson_id']),'U'])}}"><i
                                                class="fa fa-link"></i> URL ({{$record['total_urls']}})</a>
                                    </div>
                                    <div class="col-md-3 py-2">
                                        <a
                                            href="{{route('tus_libcontentbytype',[Session()->get('tenant_info')['subdomain'],\Helpers::encryptId($record['lesson_id']),'A'])}}"><i
                                                class="fa fa-file"></i> Assessments
                                            ({{$record['total_assessments']}})</a>
                                    </div>
                                    <div class="col-md-3 py-2">
                                        <a
                                            href="{{route('tus_libcontentbytype',[Session()->get('tenant_info')['subdomain'],\Helpers::encryptId($record['lesson_id']),'AS'])}}"><i
