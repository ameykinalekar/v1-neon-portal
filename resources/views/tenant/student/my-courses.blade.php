                ...
                <div class="col-md-6 col-lg-2 my-2 px-2 grid">
                    <div class="card" style="width: 100%; border-radius: 4px !important;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{route('tus_mycourseplan',[Session()->get('tenant_info')['subdomain'],\Helpers::encryptId($record['subject_id'])])}}" class="btn w-100"
                ...
                <table id="datatable" class="table table-striped  nowrap table list" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('tus_mycourseplan',[Session()->get('tenant_info')['subdomain'],\Helpers::encryptId($record['subject_id'])])}}" class="btn w-100"
                                style="background: #5BC2B9;font-size: 12px;color:#fff;border-radius: 5px;">
                                View
                            </a>
                        </td>
