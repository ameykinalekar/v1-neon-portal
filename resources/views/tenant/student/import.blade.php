...
<form method="POST" class="d-block ajaxForm"
    action="{{route('ta_saveimportstudent',Session()->get('tenant_info')['subdomain'])}}" enctype='multipart/form-data'>
    @csrf

    <div class="form-row">
        <!-- <div class="form-group mb-1">
            <label for="batch_type_id">Batch Details</label>
            <select class="form-control" id="batch_type_id" name="batch_type_id">
        ...
        <div class="form-group">
            <a target="_blank" href="{{ config('app.api_asset_url').'/sampledata/student-import-sample-format.xlsx' }}">Click to view/download sample format</a>
        </div>
