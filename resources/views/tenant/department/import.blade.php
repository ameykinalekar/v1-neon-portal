...
<form method="POST" class="d-block ajaxForm"
    action="{{route('ta_saveimportdepartment',Session()->get('tenant_info')['subdomain'])}}" enctype='multipart/form-data'>
    @csrf
    ...
    <div class="form-row">
        ...
        <div class="form-group">
            <a target="_blank" href="{{ config('app.api_asset_url').'/sampledata/department-import-sample-format.xlsx' }}">Click to view/download sample format</a>
        </div>
