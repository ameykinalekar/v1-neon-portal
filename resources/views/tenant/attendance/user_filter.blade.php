...
<form method="POST" class="d-block ajaxForm"
    action="{{route('tus_attendances',Session()->get('tenant_info')['subdomain'])}}">
    @csrf
    <div class="form-row">
        ...
        <div class="form-group mt-2 col-md-12">
            ...
            <a class="btn btn-block btn-default" href="{{route('tus_attendances', Session()->get('tenant_info')['subdomain'])}}">Reset</a>
        </div>
    </div>
</form>
@endsection
